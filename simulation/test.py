...
__RIGHT_FORWARD = "RightForward"
__RIGHT_LEG = "RightLeg"
__LEFT_LEG = "LeftLeg"
...
def robotic_arm_movement_test(current_pos, obj_pos, list_of_movements):
    ...
    for i in list_of_movements:
        prediction = rf_model.predict(i.drop("label",axis=1))
        print("-"*25) 
...
class UserDefinedTests():
    ...
    def __init__(self,current_pos,obj_pos):
        ...
        self.__LEFT_BACKWARD = "LeftBackward"
        self.__LEFT_FORWARD = "LeftForward"
        self.__RIGHT_BACKWARD ="RightBackward"
        self.__RIGHT_FORWARD = "RightForward"
    ...
    def move(self):
        ...
        for i in self.list_of_movements:
            ...
            self.logs+="-"*30+"\n"
            self.logs+="Step {0}\n".format(step)
            # self.logs+="Model Prediction : ",str(prediction[0][0])+"\n"
            # self.logs+="Actual Label : ",i.label.iloc[0]+"\n"
            print("-"*30)
            ...
            self.logs+="Updated (x,y,z) = ({0},{1},{2})".format(self.current_pos[0],self.current_pos[1],self.current_pos[2])+"\n"
    ...
    def results(self):
        ...
        #     print("Wrong Place !!")
        self.logs+="-"*30+"\n"
        self.logs+="Old Position : ({0},{1},{2})".format(self.old_x,self.old_y,self.old_z)+"\n"
        self.logs += "Target Position : ({0},{1},{2})".format(self.obj_pos[0],self.obj_pos[1],self.obj_pos[2])+"\n"
        self.logs+="Current Position : ({0},{1},{2})".format(self.current_pos[0],self.current_pos[1],self.current_pos[2])+"\n"
    ...
    def x_y(self):
        return (self.current_pos[0]-self.old_x,self.current_pos[1]-self.old_y)
